...
/**
 * Created by 李綦睿 on 2017/2/24.
 */
public class ReadFiles {
    private static ArrayList<String> FileList = new ArrayList<String>(); // the list of file

    //get list of file for the directory, including sub-directory of it   获取目录的文件列表，包括它的子目录
    ...
    //term frequency in a file, times for each word   文件中的词频，每个单词的次数
    ...
    //term frequency in a file, frequency of each word   文件中的词频，每个单词的频率
